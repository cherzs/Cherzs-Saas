        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
            <CardHeader>
              ...
              <CardTitle className="text-xl">Problem Radar</CardTitle>
              <CardDescription>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
            <CardHeader>
              ...
              <CardTitle className="text-xl">Idea Framework Engine</CardTitle>
              <CardDescription>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
            <CardHeader>
              ...
              <CardTitle className="text-xl">Validation Toolkit</CardTitle>
              <CardDescription>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Discover Problems</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Generate Ideas</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Validate & Build</h3>
              <p className="text-gray-600">
