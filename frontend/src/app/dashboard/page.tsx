      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div>
            ...
            <div className="grid gap-6">
              {mockProblems.map((problem) => (
                <Card key={problem.id} className="hover:shadow-md transition-shadow border-gray-800 bg-gray-900/50 backdrop-blur-sm">
                  <CardContent className="p-6">
        ...
        {activeTab === 'ideas' && (
          <div>
            ...
            <div className="grid gap-6">
              {mockIdeas.map((idea) => (
                <Card key={idea.id} className="hover:shadow-md transition-shadow border-gray-800 bg-gray-900/50 backdrop-blur-sm">
                  <CardContent className="p-6">
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-white mb-2">
        ...
        {activeTab === 'validation' && (
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-white">Validation Projects</h2>
              <Button size="sm" className="bg-white text-black hover:bg-gray-200">
                <Plus className="h-4 w-4 mr-2" />
                New Validation
              </Button>
